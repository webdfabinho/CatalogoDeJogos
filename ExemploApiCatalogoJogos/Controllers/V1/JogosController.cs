...
namespace ExemploApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        public async Task<ActionResult<JogoViewModel>> InserirJogo([FromBody] JogoInputModel jogoInputModel)
        {
            ...
            {
                return UnprocessableEntity("Já existe um jogo com este nome para esta produtora, escolha outro!");
            }
        }
        ...
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromBody] JogoInputModel jogoInputModel)
        {
            ...
            {
                return NotFound("Ops. Não existe este jogo verifiquye o nome e tente novamente!");
            }
        }
        ...
        public async Task<ActionResult> AtualizarJogo([FromRoute] Guid idJogo, [FromRoute] double preco)
        {
            ...
            {
                return NotFound("Ops! Não existe este jogo!");
            }
        }
